...
#-------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------
def Create_art(user_sender, user_recipient, art_name):                           # Создание блока для майнинга в котором осуществляется перевод монет
    ...
    f.writelines('data: ' + str(art_name) + '\n')
...
def Give_art(user_sender, user_recipient, sent_art):                           # Создание блока для майнинга в котором осуществляется перевод монет
    ...
    f.writelines('sent_coin: -' + '\n')
    f.writelines('user_recipient: ' + user_recipient +'\n')
    f.writelines('data: ' + str(sent_art) + '\n')
    f.writelines('previous_hash:\n')
    f.writelines('hash_key:\n')
    f.writelines('this_hash:\n')
    f.writelines('miner_name:')
