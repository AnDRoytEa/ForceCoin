...
#-------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------
def Give_coin(user_sender, user_recipient, sent_art):                           # Создание блока для майнинга в котором осуществляется перевод монет
    ...
    if (float(sent_coin) > float(balance)):
    ...
    f.writelines('sent_coin: ' + str(sent_art) + '\n')
...
Blockchain()
Block_that_needs_mining()
Give_coin(wallet_hash, user_recipient, sent_coin)
#--------------------------------------------------------------------------
