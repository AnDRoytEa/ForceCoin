...
sys.stdout.write('Хотите загрузить файл? (y/n): ')
y_or_n = input()
if y_or_n == 'y':
    sys.stdout.write('Введите название фала: ')
    sent_art = input()
    Blockchain.init()
    Block_that_needs_mining.clear()
    Block_that_needs_mining.download()
    Block_that_needs_mining.create_art(Wallet.c, Wallet.c, sent_art)



sys.stdout.write('Кому хотите отправить арт?: ')
user_recipient = input()
sys.stdout.write('Введите название арт: ')
sent_art = input()
if sent_art in Wallet.arts_name:
    Blockchain.init()
    Block_that_needs_mining.clear()
    Block_that_needs_mining.download()
    Block_that_needs_mining.give_art(Wallet.c, user_recipient, sent_art)
#--------------------------------------------------------------------------
