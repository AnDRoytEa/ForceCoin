...
def init():                                                                # Создание папок на устройстве клиента
    print('--------------------')
    folder_name = ['Database', 'Blockchain', 'Block_that_needs_mining', 'Database/Users_check', 'Database/Blockchain_check', 'Database/Block_that_needs_mining_check', 'Database/Blockchain_processing_1', 'Database/Blockchain_processing_2', 'Database/Blockchain_processing_3', 'Database/My_blocks']
