...
def main_window_1000_600():
    ...
    font = pygame.font.Font("Fonts/Buk.ttf", 30)
    sender_open = font.render("S", True, [255, 30, 30])
    ...
    while run:
        ...
        if table_status == 'yes':
            ...
            font = pygame.font.Font("Fonts/Buk.ttf", 40)
            Available_apps = font.render("Available apps", True, [235, 235, 235])
            screen.blit(Available_apps, (50, 50))

            pygame.gfxdraw.box(screen, pygame.Rect(30, 130, 120, 130), (50, 50, 50, 255))  # приложение 1
            font = pygame.font.Font("Fonts/Buk.ttf", 20)
            ForceCoin = font.render("ForceCoin", True, [235, 235, 235])
            screen.blit(ForceCoin, (55, 230))

            pygame.gfxdraw.box(screen, pygame.Rect(160, 130, 120, 130), (50, 50, 50, 255))  # приложение 2
            font = pygame.font.Font("Fonts/Buk.ttf", 20)
            loading = font.render("OpenArts", True, [235, 235, 235])
            screen.blit(loading, (185, 230))

            pygame.gfxdraw.box(screen, pygame.Rect(30, 270, 120, 130), (50, 50, 50, 255))  # приложение 3
            font = pygame.font.Font("Fonts/Buk.ttf", 20)
            Sender = font.render("Sender", True, [235, 235, 235])
            screen.blit(Sender, (65, 370))

            pygame.gfxdraw.box(screen, pygame.Rect(160, 270, 120, 130), (50, 50, 50, 255))  # приложение 4
            font = pygame.font.Font("Fonts/Buk.ttf", 20)
            Abigail = font.render("Abigail", True, [235, 235, 235])
            screen.blit(Abigail, (195, 370))

            pygame.gfxdraw.box(screen, pygame.Rect(30, 410, 120, 130), (50, 50, 50, 255))  # приложение 5

            pygame.gfxdraw.box(screen, pygame.Rect(160, 410, 120, 130), (50, 50, 50, 255))  # приложение 6
