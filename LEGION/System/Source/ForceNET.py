...
def processing_balance_info(block_id, option, wallet):
    if option == 'coin':
        balance = 0.00000000
        try:
            f = open('System/Database/Wallet_keys/public_key.txt', 'r')  # Чтение файла кошелька
        ...
        for i in range(1000000000):
            try:
                ...
                if object_type == 'coin' and sent_object == '-':
                    ...
                    user_sender_balance = processing_balance_info(i, 'coin', user_sender)
...
print('|| Protocol ForceNET (0.3)')
print('|| Support object: coin')
print(' ')
...
#a = send_coin('0.0036000', 'MEgCQQDIL1irdRrT91gIv1uU/cYZeNRBfc3wNHjKjPvUM7wNQU1lKtVpKHlnGaY/IZ6To/M14kkfFNv34sjjNzGGK9I1AgMBAAE=')
#z = upload('blockchain')
#print('ForceNET - upload(blockchain) ----',z);
#z = upload('block_that_needs_mining')
#print('ForceNET - upload(block_that_needs_mining) ----',z);
